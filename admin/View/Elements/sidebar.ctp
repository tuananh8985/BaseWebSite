...
?>>Danh mục sản phẩm</a></li>
  		         	 ...
  		         	 <li id="arrayorder_4"> <a href="<?php echo DOMAINAD ?>news" class="nav-top-item">Tin tức</a> </li>
					  
					 <li id="arrayorder_4"> <a href="<?php echo DOMAINAD ?>products" class="nav-top-item">Sản phẩm</a> </li>
				
                <li id="arrayorder_4"> <a href="<?php echo DOMAINAD ?>settings" class="nav-top-item">Cấu hình</a> </li>
		
  <li id="arrayorder_7"> <a href="<?php echo DOMAINAD ?>Posts" class="nav-top-item">Post</a> </li> 
