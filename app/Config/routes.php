 ...
 */
	...
	Router::connect('/gioi-thieu.html', array('controller' => 'Home', 'action' => 'gioithieu'));
	
	Router::connect('/tin-tuc/*', array('controller' => 'news', 'action' => 'index'));
	Router::connect('/ct-tin/*', array('controller' => 'news', 'action' => 'detail'));
	...
	Router::connect('/san-pham.html', array('controller' => 'Product', 'action' => 'index'));
