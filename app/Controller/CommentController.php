...
class CommentController extends AppController
{
    ...
    public function getRecruitment($catId = null)
    {$cat1 = array();
        $cat1[0] = $catId;
        $i = 1;
    ...
    public function get_newsale($catId = 6)
    {$cat1 = array();
        $cat1[0] = $catId;
        $i = 1;
    ...
    public function getlienthong($catId = 6)
    {$cat1 = array();
        $cat1[0] = $catId;
        $i = 1;
        $cat = $this->Catalogue->find('all', array('conditions' => array('Catalogue.status' => 1, 'Catalogue.parent_id' => $catId)));
    ...
    //menu left
    public function menu_left($id = null)
    {
    ...
    //menu left 3
    public function menu_left3($id = null)
    {
    ...
    //menu left 2
    public function menu_left2($id = 6)
    {
        return $this->Catalogue->find('all', array('conditions' => array('Catalogue.status' => 1, 'Catalogue.parent_id' => $id), 'order' => 'Catalogue.pos ASC'));
    }
    //menu footer
    public function menu_footer($id = null)
    {
    ...
    public function listdanhmuc($id = null)
    {
