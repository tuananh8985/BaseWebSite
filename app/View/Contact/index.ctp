...
else { $duoi=""; include('../Vendor/lang_vn.php');
 }?>
...
<div class="gioithieu">
	<div class="doitac1">LIÊN HỆ</div>
	<div class="gioithieu1">
 

						<div class="content6" style="padding-top: 20px;padding-bottom: 20px;padding-right: 80px;"><?php
        ...
        <table style="margin: auto;width: 524px;" border="0" cellspacing="0" cellpadding="0">
            <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="4" style="padding-left: 20px;">
                            ...
                            <tr>
                                ...
                                <td style="padding-top: 10px;"><span class="thefield">
                                        <textarea name="content1"cols="40" rows="8" style="width: 270px;" ></textarea>
                                    </span></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
